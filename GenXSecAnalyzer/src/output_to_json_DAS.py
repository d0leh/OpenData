...
fields = ['totX_beforeMat', 'totX_beforeMat_err', 'totX_afterMat', 'totX_afterMat_err', 'matchingEff', 'matchingEff_err', 'filterEff_weights', 'filterEff_weights_err', 'filterEff_event', 'filterEff_event_err', 'totX_final\
', 'totX_final_err', 'negWeightFrac', 'negWeightFrac_err', 'equivLumi', 'equivLumi_err']
